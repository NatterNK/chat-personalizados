...
import { Sparkles, Landmark, Atom, Binary, Compass, ArrowUpRight, HelpCircle, BookOpen } from 'lucide-react';
...
export const Sidebar = ({
  ...
  return (
    <aside className="w-80 min-w-[320px] bg-[#0b0e14] border-r border-[#1e2633] flex flex-col justify-between p-4 sm:p-5 select-none shrink-0 overflow-y-auto custom-scrollbar">
      <div className="space-y-5">
        ...
        {/* Panel de Guía de Indagación Crítica + Biblioteca Esencial */}
        {guide && (
          <div className="p-4 sm:p-5 rounded-2xl bg-[#12161f] border border-[#21262d] space-y-3.5 shadow-lg shadow-black/30">
            {/* Header del Foco */}
              ...
              <div className="pt-2.5 border-t border-[#21262d] space-y-2">
                ...
                <div className="space-y-2">
                  {guide.preguntas.map((q, idx) => (
                    <button
                      key={idx}
                      onClick={() => !isProcessing && onSelectQuestion && onSelectQuestion(q)}
